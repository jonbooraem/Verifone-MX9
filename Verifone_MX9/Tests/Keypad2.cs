...
namespace Verifone_MX9.Tests
{
    class Keypad2
    {
        ...
        public Keypad2(Form1 form_1, int port)
        {
        ...
        public void Start_Test()
        {
            ...
            int timeout;
            if (ConfigurationManager.AppSettings.Get("KeypadTimeout").Equals("NONE")) timeout = -1;
            else timeout = Int32.Parse(ConfigurationManager.AppSettings.Get("KeypadTimeout"));
